...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Service is running", "Il servizio Ã¨ in esecuzione"),
        ("Service is not running", "Il servizio non Ã¨ in esecuzione"),
        ...
        ("Not an empty directory", "Non Ã¨ una cartella vuota"),
        ...
        ("This is irreversible!", "Questo Ã¨ irreversibile!"),
        ("Deleting", "Eliminazione di"),
        ("files", "file"),
        ("Waiting", "In attesa"),
        ("Finished", "Completato"),
        ("Speed", "VelocitÃ "),
        ("Custom Image Quality", "QualitÃ  immagine personalizzata"),
        ("Privacy mode", "ModalitÃ  privacy"),
        ...
        ("Good image quality", "QualitÃ  immagine buona"),
        ("Balanced", "Bilanciata qualitÃ /velocitÃ "),
        ("Optimize reaction time", "Ottimizza tempo reazione"),
        ("Custom", "Profilo personalizzato"),
        ("Show remote cursor", "Visualizza cursore remoto"),
        ("Show quality monitor", "Visualizza qualitÃ  video"),
        ...
        ("Please try later", "Riprova piÃ¹ tardi"),
        ("Remote desktop is offline", "Il desktop remoto Ã¨ offline"),
        ...
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a RustDesk il permesso 'AccessibilitÃ '."),
        ...
        ("Your installation is lower version.", "Questa installazione non Ã¨ aggiornata."),
        ...
        ("setup_server_tip", "Per una connessione piÃ¹ veloce, configura uno specifico server"),
        ...
        ("Fix it", "Risolvi"),
        ("Warning", "Avviso"),
        ("Login screen using Wayland is not supported", "La schermata di accesso non Ã¨ supportata usando Wayland"),
        ...
        ("verification_tip", "Ãˆ stato inviato un codice di verifica all'indirizzo email registrato, per accedere inserisci il codice di verifica."),
        ("Logout", "Esci"),
        ("Tags", "Etichette"),
        ("Search ID", "Cerca ID"),
        ...
        ("The verification code is incorrect or has expired", "Il codice di verifica non Ã¨ corretto o Ã¨ scaduto"),
        ...
        ("Discovered", "Rilevate"),
        ("install_daemon_tip", "Per avviare il programma all'accensione, Ã¨ necessario installarlo come servizio di sistema."),
        ("Remote ID", "ID remoto"),
        ("Paste", "Incolla"),
        ...
        ("Touch mode", "ModalitÃ  tocco"),
        ("Mouse mode", "ModalitÃ  mouse"),
        ...
        ("android_input_permission_tip1", "AffinchÃ© un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a RustDesk di usare il servizio 'AccessibilitÃ '."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirÃ  di seguito, trova e accedi a [Servizi installati], attiva il servizio [RustDesk Input]."),
        ("android_new_connection_tip", "Ãˆ stata ricevuta una nuova richiesta di controllo per il dispositivo attuale."),
        ("android_service_will_start_tip", "L'attivazione di Cattura schermo avvierÃ  automaticamente il servizio, consentendo ad altri dispositivi di richiedere una connessione da questo dispositivo."),
        ("android_stop_service_tip", "La chiusura del servizio chiuderÃ  automaticamente tutte le connessioni stabilite."),
        ...
        ("Someone turns on privacy mode, exit", "Qualcuno ha attivato la modalitÃ  privacy, uscita"),
        ...
        ("Legacy mode", "ModalitÃ  legacy"),
        ("Map mode", "ModalitÃ  mappa"),
        ("Translate mode", "ModalitÃ  traduzione"),
        ...
        ("Copied", "Copiato"),
        ("Exit Fullscreen", "Esci dalla modalitÃ  schermo intero"),
        ...
        ("Ratio", "Rapporto"),
        ("Image Quality", "QualitÃ  immagine"),
        ...
        ("elevated_foreground_window_tip", "La finestra attuale del desktop remoto richiede per funzionare privilegi piÃ¹ elevati, quindi non Ã¨ possibile usare temporaneamente il mouse e la tastiera.\nÃˆ possibile chiedere all'utente remoto di ridurre a icona la finestra attuale o di selezionare il pulsante di elevazione nella finestra di gestione della connessione.\nPer evitare questo problema, ti consigliamo di installare il software nel dispositivo remoto."),
        ("Disconnected", "Disconnesso"),
        ("Other", "Altro"),
        ("Confirm before closing multiple tabs", "Conferma prima di chiudere piÃ¹ schede"),
        ...
        ("wayland_experiment_tip", "Il supporto Wayland Ã¨ in fase sperimentale, se vuoi un accesso stabile usa X11."),
        ...
        ("software_render_tip", "Se nel computer con Linux Ã¨ presente una scheda grafica Nvidia e la finestra remota si chiude immediatamente dopo la connessione, installa il nuovo driver open source e usa il rendering software.\nPotrebbe essere necessario un riavvio del programma."),
        ("Always use software rendering", "Usa sempre rendering software"),
        ("config_input", "Per controllare il desktop remoto con la tastiera, Ã¨ necessario concedere le autorizzazioni a RustDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, Ã¨ necessario concedere l'autorizzazione 'Registra audio' a RustDesk."),
        ("request_elevation_tip", "Se c'Ã¨ qualcuno nel lato remoto Ã¨ possibile richiedere l'elevazione."),
        ("Wait", "Attendi"),
        ...
        ("Choose this if the remote account is administrator", "Scegli questa opzione se l'account remoto Ã¨ amministratore"),
        ...
        ("Default Image Quality", "QualitÃ  immagine predefinita"),
        ...
        ("relay_hint_tip", "Se non Ã¨ possibile connettersi direttamente, puoi provare a farlo tramite relay.\nInoltre, se si vuoi usare il relay al primo tentativo, Ã¨ possibile aggiungere all'ID il suffisso '/r\' o selezionare nella scheda se esiste l'opzione 'Collegati sempre tramite relay'."),
        ...
        ("empty_recent_tip", "Non c'Ã¨ nessuna sessione recente!\nPianificane una."),
        ...
        ("Me", "Io"),
        ("identical_file_tip", "Questo file Ã¨ identico a quello nel dispositivo remoto."),
        ("show_monitors_tip", "Visualizza schermi nella barra strumenti"),
        ("View Mode", "ModalitÃ  visualizzazione"),
        ...
        ("Can not be empty", "Non puÃ² essere vuoto"),
        ("Already exists", "Esiste giÃ "),
        ...
        ("scam_text2", "Probabilmente Ã¨ un truffatore che cerca di rubare i tuoi soldi o altre informazioni private."),
        ("Don't show again", "Non visualizzare piÃ¹"),
        ("I Agree", "Accetto"),
        ("Decline", "Non accetto"),
        ("Timeout in minutes", "Timeout in minuti"),
        ("auto_disconnect_option_tip", "Chiudi automaticamente sessioni in entrata per inattivitÃ  utente"),
        ("Connection failed due to inactivity", "Connessione non riuscita a causa di inattivitÃ "),
        ...
        ("Test", "Test"),
        ("display_is_plugged_out_msg", "Lo schermo Ã¨ scollegato, passo al primo schermo."),
        ...
        ("selinux_tip", "In questo dispositivo Ã¨ abilitato SELinux, che potrebbe impedire il corretto funzionamento di RustDesk come lato controllato."),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra RustDesk Ã¨ aperta"),
        ("no_need_privacy_mode_no_physical_displays_tip", "Nessun display fisico, nessuna necessitÃ  di usare la modalitÃ  privacy."),
        ...
        ("clear_Wayland_screen_selection_tip", "Dopo aver annullato la selezione schermo, Ã¨ possibile selezionare nuovamente lo schermo da condividere."),
        ("confirm_clear_Wayland_screen_selection_tip", "Vuoi annullare la selezione schermo Wayland?"),
        ("android_new_voice_call_tip", "Ãˆ stata ricevuta una nuova richiesta di chiamata vocale. Se accetti, l'audio passerÃ  alla comunicazione vocale."),
        ("texture_render_tip", "Usa il rendering texture per rendere le immagini piÃ¹ fluide. Se riscontri problemi di rendering prova a disabilitare questa opzione."),
        ...
        ("During service is on", "Quando il servizio Ã¨ attivo"),
        ...
        ("one-way-file-transfer-tip", "Sul lato controllato Ã¨ abilitato il trasferimento file unidirezionale."),
        ("Authentication Required", "Richiesta autenticazione"),
        ("Authenticate", "Autentica"),
        ("web_id_input_tip", "Ãˆ possibile inserire un ID nello stesso server, nel client web non Ã¨ supportato l'accesso con IP diretto.\nSe vuoi accedere ad un dispositivo in un altro server, aggiungi l'indirizzo del server (<id>@<indirizzo_server>?key=<valore_chiave >), ad esempio,\n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=.\nSe vuoi accedere ad un dispositivo in un server pubblico, inserisci \"<id>@public\", la chiave non Ã¨ necessaria per il server pubblico."),
        ("Download", "Download"),
        ...
        ("Untagged", "Senza tag"),
        ("new-version-of-{}-tip", "Ãˆ disponibile una nuova versione di {}"),
        ...
        ("d3d_render_tip", "Quando Ã¨ abilitato il rendering D3D, in alcuni computer la schermata del telecomando potrebbe essere nera."),
        ...
        ("printer-requires-installed-{}-client-tip", "Per usare la stampa remota, {} Ã¨ necessario installare il programma nel dispositivo."),
        ("printer-{}-not-installed-tip", "La stampante {} non Ã¨ installata."),
        ("printer-{}-ready-tip", "La stampante {} Ã¨ installata e pronta all'uso."),
        ...
        ("dont-show-again-tip", "Non visualizzare piÃ¹ questo messaggio"),
        ("Take screenshot", "Cattura schermata"),
        ("Taking screenshot", "Cattura schermata"),
        ("screenshot-merged-screen-not-supported-tip", "L'unione della cattura di schermate di piÃ¹ display non Ã¨ attualmente supportata.\nPassa ad un singolo display e riprova."),
        ...
        ("{} Update", "Aggiorna {}"),
        ("{}-to-update-tip", "{} si chiuderÃ  e installerÃ  la nuova versione"),
        ("download-new-version-failed-tip", "Download non riuscito.\nÃˆ possibile riprovare o selezionare 'Download' per scaricare e aggiornarlo manualmente."),
        ...
        ("Trackpad speed", "VelocitÃ  trackpad"),
        ("Default trackpad speed", "VelocitÃ  predefinita trackpad"),
        ...
        ("The user is not an administrator.", "L'utente non Ã¨ un amministratore."),
        ("Failed to check if the user is an administrator.", "Impossibile verificare se l'utente Ã¨ un amministratore."),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, RustDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, RustDesk salterÃ  il passaggio di verifica e procederÃ  in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione Ã¨ abilitata, RustDesk non userÃ  piÃ¹ UDP 21116, verrÃ  invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server RustDesk non include questa funzionalitÃ ."),
        ...
        ("Relative mouse mode", "ModalitÃ  relativa mouse"),
        ("rel-mouse-not-supported-peer-tip", "La modalitÃ  mouse relativa non Ã¨ supportata dal peer connesso."),
        ("rel-mouse-not-ready-tip", "La modalitÃ  mouse relativa non Ã¨ ancora pronta. Riprova."),
        ("rel-mouse-lock-failed-tip", "Impossibile bloccare il cursore. La modalitÃ  mouse relativa Ã¨ stata disabilitata."),
        ("rel-mouse-exit-{}-tip", "Premi {} per uscire."),
        ("rel-mouse-permission-lost-tip", "Ãˆ stata revocato l'accesso alla tastiera. La modalitÃ  mouse relativa Ã¨ stata disabilitata."),
        ("Changelog", "NovitÃ  programma"),
        ...
        ("password-hidden-tip", "Ãˆ impostata una password permanente (nascosta)."),
        ("preset-password-in-use-tip", "Ãˆ attualmente in uso la password preimpostata."),
        ("Enable privacy mode", "Abilita modalitÃ  privacy"),
        ...
        ("wayland-keyboard-input-consent-tip", "CiÃ² che digiti in questo computer remoto (comprese le password) potrebbe essere letto da altre app presenti nel computer remoto."),
        ...
        ("remember-wayland-keyboard-choice-tip", "Non chiedere piÃ¹ per questo computer remoto"),
        ("Why this happens", "PerchÃ© accade questo"),
        ...
        ("Your ID is blocked by the peer", "Il tuo ID Ã¨ bloccato dal dispositivo remoto"),
        ("Your ip is blocked by the peer", "Il tuo IP Ã¨ bloccato dal dispositivo remoto"),
        ("id_whitelist_caveat_tip", "L'ID Ã¨ dichiarato dal client che si connette. Questo elenco riduce l'esposizione e non sostituisce la password o la 2FA"),
        ("whitelist_cidr_tip", "Ãˆ supportata la notazione CIDR, ad esempio 192.168.1.0/24"),
        ("Continue", "Continua"),
        ("Browser didn't open? Use the url below to sign in.", "Il browser non si Ã¨ aperto? Usa l'URL qui sotto per accedere."),
        ...
        ("terminal-clipboard-write-tip", "Un'app nel terminale vuole copiare il testo negli appunti di questo dispositivo. Se concessa, questa autorizzazione si applica alle app terminali in tutte le connessioni finchÃ© non la disattivi in Impostazioni. Le operazioni di copia e incolla manuali non sono interessate."),
        ...
        ("The screen sharing request was declined on the remote device", "La richiesta di condivisione dello schermo nel dispositivo remoto Ã¨ stata rifiutata"),
        ("The screen sharing request timed out on the remote device", "La richiesta di condivisione dello schermo nel dispositivo remoto Ã¨ scaduta"),
        ...
        ("The desktop portal on the remote device is missing a capability needed for screen sharing or remote control, its backend may not be installed", "Nel portale desktop nel dispositivo remoto manca una funzionalitÃ  necessaria per la condivisione dello schermo o il controllo remoto, il relativo backend potrebbe non essere installato"),
        ("Screen sharing was approved on the remote device, but the PipeWire connection could not be opened", "La condivisione dello schermo Ã¨ stata approvata nel dispositivo remoto, ma non Ã¨ stato possibile aprire la connessione PipeWire"),
        ("The screen sharing request ended without completing on the remote device", "La richiesta di condivisione dello schermo si Ã¨ chiusa senza essere completata nel dispositivo remoto"),
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "RustDesk non Ã¨ riuscito a ottenere una schermata usabile dal portale desktop XDG, la libreria PipeWire potrebbe essere troppo vecchia"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "RustDesk non Ã¨ riuscito a caricare un componente GStreamer necessario per l'acquisizione dello schermo ({})"),
        ("Relay fallback delay in seconds", "Ritardo fallback relay (secondi)"),
        ("relay-fallback-delay-tip", "Quanto tempo una connessione relay giÃ  attiva attende la connessione WebRTC diretta prima di essere usata. Aumentalo per dare a una connessione diretta lenta piÃ¹ tempo per funzionare; diminuiscilo per passare prima al relay sulle reti in cui non Ã¨ possibile effettuare una connessione diretta. Lascia vuoto per il valore predefinito di 2,5 secondi."),
