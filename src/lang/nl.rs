...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable file copy and paste", "KopiÃ«ren en plakken van bestanden toestaan"),
        ("Connected", "Verbonden"),
        ...
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [GeÃ¯nstalleerde Services], schakel de service [RustDesk Input] in."),
        ...
        ("Copy Fingerprint", "Vingerafdruk kopiÃ«ren"),
        ...
        ("scam_text2", "Het is waarschijnlijk een oplichter die probeert uw geld of andere privÃ©gegevens te stelen."),
        ...
        ("Enter privacy mode", "PrivÃ©modus openen"),
        ("Exit privacy mode", "PrivÃ©modus afsluiten"),
        ...
        ("wrong-2fa-code", "Kan de code niet verifiÃ«ren. Controleer of de code en lokale tijdinstellingen correct zijn."),
        ...
        ("no_need_privacy_mode_no_physical_displays_tip", "Geen fysieke schermen, geen privÃ©modus nodig."),
        ...
        ("printer-requires-installed-{}-client-tip", "Om afdrukken op afstand te gebruiken, moet {} geÃ¯nstalleerd zijn op dit apparaat."),
        ("printer-{}-not-installed-tip", "De printer {} is niet geÃ¯nstalleerd."),
        ("printer-{}-ready-tip", "De printer {} is geÃ¯nstalleerd en klaar voor gebruik."),
        ...
        ("Copy to clipboard", "KopiÃ«ren naar het klembord"),
        ("Enable remote printer", "Printer op afstand inschakelen"),
        ("Downloading {}", "Downloaden {}"),
        ("{} Update", "{} bijwerken"),
        ("{}-to-update-tip", "{} zal sluiten en de nieuwe versie installeren."),
        ("download-new-version-failed-tip", "Fout bij het downloaden. Je kunt het opnieuw proberen of op de knop Downloaden klikken om de applicatie van de officiÃ«le website te downloaden en handmatig bij te werken."),
        ("Auto update", "Automatisch updaten"),
        ("update-failed-check-msi-tip", "Kan de installatiemethode niet bepalen. Klik op â€œDownloadenâ€ om de applicatie van de officiÃ«le website te downloaden en handmatig bij te werken."),
        ...
        ("Supported only in the installed version.", "Alleen ondersteund in de geÃ¯nstalleerde versie."),
        ...
        ("Enable privacy mode", "PrivÃ©modus inschakelen"),
        ...
        ("id_whitelist_wildcard_tip", "Wildcards worden ondersteund: '*' komt overeen met een willekeurig aantal tekens, '?' komt overeen met Ã©Ã©n teken"),
        ...
        ("sync-clipboard-between-sessions-tip", "Tekst of afbeeldingen die in Ã©Ã©n externe sessie worden gekopieerd, worden ook naar het klembord van uw andere verbonden sessies gestuurd."),
        ("terminal-clipboard-write-tip", ""),
        ("Allow terminal apps to copy to clipboard", ""),
        ("Enable", "Inschakelen"),
        ("Reuse one connection for port forwarding", "EÃ©n verbinding hergebruiken voor poortdoorschakeling"),
        ("port-forward-mux-tip", "Alle verbindingen van een poortdoorschakeling via Ã©Ã©n enkele verbinding met de andere computer laten lopen, in plaats van voor elke verbinding opnieuw verbinding te maken en in te loggen."),
        ...
        ("The desktop portal on the remote device is missing a capability needed for screen sharing or remote control, its backend may not be installed", "De bureaubladportal op het externe apparaat mist een functie die nodig is voor schermdeling of besturing op afstand, de backend is mogelijk niet geÃ¯nstalleerd"),
        ...
        ("The screen sharing request ended without completing on the remote device", "Het verzoek om schermdeling op het externe apparaat is geÃ«indigd zonder te zijn voltooid"),
