...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("OyazDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.132.110"];
pub const RS_PUB_KEY: &str = "vemPFS04UF2wEQaEKwiH55ua7wDdAMmUqPjycQDbRLk=";
